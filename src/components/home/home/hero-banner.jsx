...
// content
const content = {
  sub_title: "Bienvenidos a Central Medica",
  title: (
    <>
      Productos de Ostomía Hollister<br />
       y Capacitación para Enfermeras
    </>
  ),
  des: (
    <>
      Insumos y Materiales de Curación de Alta Calidad{" "}
      <br />
      Atención Personalizada y Asesoría Especializada.
    </>
  ),
  btn_text1: "Contactanos",
  btn_text2: "Acerca de nosotros",
};
    ...
    <>
      <section className="banner-area p-relative pt-90">
        ...
        <div className="banner__shape d-none d-lg-block">
          <img src="/assets/img/banner/banner-curacion-hollister.png" alt="banner-img" />
